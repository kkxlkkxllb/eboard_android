...
import static org.eboard.app.core.Constants.Http.URL_WORDS;
import static org.eboard.app.core.Constants.Http.URL_CHECKINS;
import static org.eboard.app.core.Constants.Http.URL_MOVIES;
...
//        request.header(HEADER_PARSE_APP_ID, PARSE_APP_ID);
    ...
    public List<Word> getWords() throws IOException {
        try {
            final HttpRequest request = execute(HttpRequest.get(URL_WORDS));
            final Word[] response = fromJson(request, Word[].class);
            if (response != null) {
    ...
    public List<Movie> getMovies() throws IOException {
        try {
            final HttpRequest request = execute(HttpRequest.get(URL_MOVIES + "/?s=god"));
            final MovieWrapper response = fromJson(request, MovieWrapper.class);
