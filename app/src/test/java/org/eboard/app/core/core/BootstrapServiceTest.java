...
package org.eboard.app.core.core;
...
import org.eboard.app.core.CheckIn;
...
/**
 * Unit tests of {@link org.eboard.app.core.BootstrapService}
 */
...
public class BootstrapServiceTest {
    ...
    public void getContentEmptyResponse() throws IOException {
        doReturn(createReader("")).when(request).bufferedReader();
        List<Word> content = service.getWords();
