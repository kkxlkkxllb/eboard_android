...
/*
 * Class:     org_eboard_app_rtmp_SayHi
 * Method:    Init
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_eboard_app_rtmp_SayHi_Init(JNIEnv *env, jobject jobj)
{
    SLresult result;
...
//    }
    ...
    LOGI("Java_org_eboard_app_rtmp_SayHi_Init");
...
JNIEXPORT void JNICALL Java_org_eboard_app_rtmp_SayHi_OpenPublisher(JNIEnv *env, jobject jobj, jstring jRtmpUrl)
{
    if (isOpenPub) {
        return;
    }
    LOGI("Java_org_eboard_app_rtmp_SayHi_OpenPublisher");
 ...
 * Signature: ()V
 */JNIEXPORT void JNICALL Java_org_eboard_app_rtmp_SayHi_ClosePublisher(JNIEnv *env, jobject jobj)
{
    pthread_mutex_lock(&recodMutex);
    isStartPub = 0;
    pthread_cond_signal(&recodCond);
    pthread_mutex_unlock(&recodMutex);
    LOGI("Java_org_eboard_app_rtmp_SayHi_ClosePublisher");
}
...
JNIEXPORT void JNICALL Java_org_eboard_app_rtmp_SayHi_OpenPlayer(JNIEnv *env, jobject jobj, jstring jRtmpUrl)
{
    if (isOpenPlay) {
        return;
    }
    LOGI("Java_org_eboard_app_rtmp_SayHi_OpenPlayer");
    const char* rtmpUrl = (*env)->GetStringUTFChars(env, jRtmpUrl, 0);
...
JNIEXPORT void JNICALL Java_org_eboard_app_rtmp_SayHi_ClosePlayer(JNIEnv *env, jobject jobj)
{
    isStartPlay = 0;
}
 ...
 * Method:    Deinit
 * Signature: ()V
 */JNIEXPORT void JNICALL Java_org_eboard_app_rtmp_SayHi_Deinit(JNIEnv *env, jobject jobj)
{
