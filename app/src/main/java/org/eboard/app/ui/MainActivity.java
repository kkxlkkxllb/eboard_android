...
import org.eboard.app.events.NavItemSelectedEvent;
import org.eboard.app.util.Ln;
import org.eboard.app.util.SafeAsyncTask;
import org.eboard.app.util.UIUtils;
 ...
 * {@link org.eboard.app.authenticator.ApiKeyProvider#getAuthKey(android.app.Activity)}
 */
...
//                return true;
    ...
    private void navigateToAudio() {
        final Intent i = new Intent(this, AudioActivity.class);
        startActivity(i);
    }
